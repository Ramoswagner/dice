...
// getBoundingClientRect() é mais confiável que offsetWidth em mobile:
// offsetWidth pode retornar 0 antes do layout estar completo.
// Fallback para viewport menos padding quando o canvas ainda não tem dimensão.
const rect     = canvas.getBoundingClientRect();
const displayW = rect.width  || (window.innerWidth - 32);
